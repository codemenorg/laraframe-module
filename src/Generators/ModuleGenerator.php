...
use Codemen\Modules\FileRepository;
...
class ModuleGenerator extends Generator
{
        ...
        foreach ($this->getFiles() as $stub => $file) {
            if(Str::contains($file, 'Config/')){
                if($file === 'Config/config.php') {
                    $file = sprintf("Config/%s.php", strtolower($this->getName()));
                }else{
                    $file = sprintf("Config/%s_%s", strtolower($this->getName()), basename($file));
                }

            }elseif (Str::contains($file, 'Routes/')){
                $file = sprintf("Routes/%s_%s", strtolower($this->getName()), basename($file));
            }
     ...
     * @return string
     */
    protected function getModulePriorityReplacement()
    {
        return Module::count() + 1;
    }
