...
class RouteProviderMakeCommand extends GeneratorCommand
{
    ...
    {
        $module = $this->laravel['modules']->findOrFail($this->getModuleName());
        $name = basename($this->laravel['modules']->config("stubs.files.routes/web"));
        return '/' . "Routes/{$module->getLowerName()}_{$name}";
    }
    ...
    {
        $module = $this->laravel['modules']->findOrFail($this->getModuleName());
        $name = basename($this->laravel['modules']->config("stubs.files.routes/api"));
        return '/' .  "Routes/{$module->getLowerName()}_{$name}";
    }
